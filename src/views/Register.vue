    ...
    <el-form :model="RegisterForm" :rules="RegisterRule"
      ...
      class="register-page">
        ...
        <el-form-item prop="sex">
          <input type="radio" name="radios" value="男" v-model="sex" ><label id="man">男</label>
          <input type="radio" name="radios" value="女" v-model="sex"><label>女</label>
        </el-form-item>
        ...
        <el-form-item style="width:100%;">
          <el-button type="primary" style="width:40%;" @click="handleSubmit">确认</el-button>
          <el-button type="primary" style="width:40%;" @click="register">取消</el-button>
        </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  data(){
    return {
      ...
      RegisterRule: {
        username: [{required: true, message: '请输入真实名字', trigger: 'blur'}],
  ...
  methods: {
    handleSubmit (arr) {
      ...
      var loginMessage = {"username": username, "nickname": nickname, "province": province, "city": city, "district": district,
       "address":address, "sex":sex,"company":company, "phoneNumber":phoneNumber, "email":email,"password": password,"idCard":idCard}
      var toGo = this.$router
      this.axios.post("http://localhost:40000/register",loginMessage)
